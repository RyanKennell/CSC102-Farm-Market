...
namespace KennellProject2 {
    ...
    public partial class ProductsDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(string Name, decimal Price, int Quantity) {
...
namespace KennellProject2.ProductsDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Name], [Price], [Quantity]) VALUES (@Name, @Price, @Q" +
                "uantity);\r\nSELECT Id, Name, Price, Quantity FROM [Table] WHERE (Id = SCOPE_IDENT" +
                "ITY())";
...
SELECT Id, Name, Price, Quantity FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::KennellProject2.Properties.Settings.Default.ProductsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Price, Quantity FROM dbo.[Table]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Price FROM dbo.[Table] Where Id = @id AND Lower(Name) = @name AND Price = " +
        ...
        public virtual int Update(string Name, global::System.Nullable<decimal> Price, global::System.Nullable<int> Quantity, int Original_Id, string Original_Name, global::System.Nullable<decimal> Original_Price, global::System.Nullable<int> Original_Quantity, int Id) {
            if ((Name == null)) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual object PurchaseQuery(int id, string name, global::System.Nullable<decimal> price, global::System.Nullable<int> quantity) {
